...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.wdpop_core_gutenberg_blocks ) { return; }

  Object.values(window.wdpop_core_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'wdpop_core-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary wdpop_core-shortcode-button',
              onClick: function () {
                window.wdpop_core_gutenberg_props = props;
              },
            }, block.button_title ),
