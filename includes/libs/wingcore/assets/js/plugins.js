...
* MIT License
*
* Customized by Wingdevs
*
*/
(function($) {

  function WDPOP_COREAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  WDPOP_COREAjaxChosen.prototype.init = function() {
  ...
  WDPOP_COREAjaxChosen.prototype.events = function() {
  ...
  WDPOP_COREAjaxChosen.prototype.search_field_focused = function() {
  ...
  WDPOP_COREAjaxChosen.prototype.search_welcome_message = function() {
  ...
  WDPOP_COREAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('wdpop_core-chosen', _this.options.data).done( function( response ) {
  ...
  WDPOP_COREAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.wdpop_core-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.WDPOP_COREChosenOrder($hidden_value, true);
  ...
  $.fn.WDPOP_COREAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new WDPOP_COREAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, WDPOP_COREAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  WDPOP_COREAbstractChosenOrder = (function() {

    function WDPOP_COREAbstractChosenOrder() {}

    WDPOP_COREAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    WDPOP_COREAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    WDPOP_COREAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    WDPOP_COREAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    WDPOP_COREAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    WDPOP_COREAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    WDPOP_COREAbstractChosenOrder.WDPOP_COREChosenOrder = function(select, order, force) {
    ...
    return WDPOP_COREAbstractChosenOrder;
  ...
  $.fn.extend({
    WDPOP_COREChosenOrder: function(order, force) {
      return _WDPOP_COREChosenOrder.WDPOP_COREChosenOrder(this, order, force);
    }
  });

  this._WDPOP_COREChosenOrder = (function(_super) {
    __extends(_WDPOP_COREChosenOrder, _super);

    function _WDPOP_COREChosenOrder() {
      _ref = _WDPOP_COREChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _WDPOP_COREChosenOrder.relAttributeName = 'data-option-array-index';

    _WDPOP_COREChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _WDPOP_COREChosenOrder.getDOMElement = function(element) {
    ...
    _WDPOP_COREChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _WDPOP_COREChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _WDPOP_COREChosenOrder;

  })(WDPOP_COREAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('wdpop_core-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('wdpop_core-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectWDPOP_CORE = FormSerializer.serializeObject;
    $.fn.serializeJSONWDPOP_CORE   = FormSerializer.serializeJSON;
  }
