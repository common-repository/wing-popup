 ...
 *
 */
if ( ! class_exists( 'WDPOP_Fields' ) ) {
  abstract class WDPOP_Fields extends WDPOP_Abstract {
    public $field;
    public $value;
    public $unique;
    public $where;
    ...
    public function field_before() {
      return ( ! empty( $this->field['before'] ) ) ? '<div class="wdpop_core-before-text">'. $this->field['before'] .'</div>' : '';
    }

    public function field_after() {

      $output  = ( ! empty( $this->field['after'] ) ) ? '<div class="wdpop_core-after-text">'. $this->field['after'] .'</div>' : '';
      $output .= ( ! empty( $this->field['desc'] ) ) ? '<div class="clear"></div><div class="wdpop_core-desc-text">'. $this->field['desc'] .'</div>' : '';
      $output .= ( ! empty( $this->field['help'] ) ) ? '<div class="wdpop_core-help"><span class="wdpop_core-help-text">'. $this->field['help'] .'</span><i class="fas fa-question-circle"></i></div>' : '';
      $output .= ( ! empty( $this->field['_error'] ) ) ? '<div class="wdpop_core-error-text">'. $this->field['_error'] .'</div>' : '';
